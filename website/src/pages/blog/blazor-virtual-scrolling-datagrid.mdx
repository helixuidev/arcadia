...
description: "Render 100,000+ rows in a Blazor DataGrid with virtual scrolling at 60fps. Zero lag, smooth scrolling, configurable overscan. Part of Arcadia Controls Pro ($299/dev/year)."
date: "2026-03-29"
...
Virtual scrolling is included in the Arcadia DataGrid Pro package ($299/dev/year). [View pricing](https://arcadiaui.com/#pricing).
