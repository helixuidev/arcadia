...
description: 11 chart types + 7 dashboard widgets for Blazor. Native SVG rendering, zero JS dependencies.
---
...
A dashboard analytics toolkit for Blazor — 11 chart types and 7 pre-composed dashboard widgets. Native SVG rendering with zero JavaScript dependencies.
