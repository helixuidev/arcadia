...
/// </summary>
public class TestInput : HelixUI.Core.Base.HelixInputBase<string>
{
...
/// </summary>
public class TestNumericInput : HelixUI.Core.Base.HelixInputBase<int>
{
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        builder.OpenElement(0, "input");
...
public class HelixInputBaseTests : BunitContext
{
    ...
    public void ImplementsIHasDisabled()
    {
        ...
        cut.Instance.Should().BeAssignableTo<HelixUI.Core.Abstractions.IHasDisabled>();
    }
