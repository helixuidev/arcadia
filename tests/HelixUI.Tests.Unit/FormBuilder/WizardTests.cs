...
using HelixUI.FormBuilder.Components;
...
public class WizardTests : BunitContext
{
    ...
    public void Renders_StepNavigation()
    {
        ...
        var buttons = cut.FindAll(".helix-wizard__step-btn");
    ...
    public void Shows_CurrentStep_Content()
    {
        ...
        cut.Find(".helix-wizard__panel").TextContent.Should().Contain("First Step Content");
        cut.Find(".helix-wizard__panel").TextContent.Should().NotContain("Second Step Content");
    }
    ...
    public void Shows_ProgressBar()
    {
        ...
        cut.FindAll(".helix-wizard__progress").Should().HaveCount(1);
    }
    ...
    public void Shows_NextButton_NotComplete_OnNonLastStep()
    {
        ...
        cut.FindAll(".helix-wizard__btn--next").Should().HaveCount(1);
        cut.FindAll(".helix-wizard__btn--complete").Should().BeEmpty();
        cut.FindAll(".helix-wizard__btn--prev").Should().BeEmpty();
    }
}
