...
public class ThemeProviderTests : BunitContext
{
    ...
    public void Renders_WithLightThemeByDefault()
    {
        ...
        cut.Find("div").GetAttribute("data-helix-theme").Should().Be("light");
    }
    ...
    public void Renders_WithDensityAttribute()
    {
        ...
        cut.Find("div").GetAttribute("data-helix-density").Should().Be("compact");
    }
    ...
    public void Renders_DefaultDensity()
    {
        ...
        cut.Find("div").GetAttribute("data-helix-density").Should().Be("default");
    }
    ...
    public void Renders_WithHelixThemeProviderClass()
    {
        ...
        cut.Find("div").ClassList.Should().Contain("helix-theme-provider");
    }
    ...
    public void Renders_WithCustomClass()
    {
        ...
        classes.Should().Contain("helix-theme-provider");
    ...
    public void Updates_WhenThemeChanges()
    {
        ...
        cut.Find("div").GetAttribute("data-helix-theme").Should().Be("dark");
    }
